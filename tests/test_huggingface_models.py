...
def test_bert_random(data_dir):
    # "hf-internal-testing/tiny-random-bert"
    check_model(data_dir / "pt5",
                {'Model': 'some',
                'Vector-matrix multiplications found': 41,
                'ops': [{'Output': (32, 32), 'Weights': (32, 32), 'Input': (32, 32)},
                {'Output': (32, 32), 'Weights': (32, 32), 'Input': (32, 32)},
                {'Output': (32, 32), 'Weights': (32, 32), 'Input': (32, 32)},
                {'Output': (4, 32, 32), 'Weights': (4, 8, 32), 'Input': (4, 32, 8)},
                {'Output': (4, 32, 8), 'Weights': (4, 32, 8), 'Input': (4, 32, 32)},
                {'Output': (32, 32), 'Weights': (32, 32), 'Input': (32, 32)},
                {'Output': (32, 37), 'Weights': (32, 37), 'Input': (32, 32)},
                {'Output': (32, 32), 'Weights': (37, 32), 'Input': (32, 37)},
                {'Output': (32, 32), 'Weights': (32, 32), 'Input': (32, 32)},
                {'Output': (32, 32), 'Weights': (32, 32), 'Input': (32, 32)},
                {'Output': (32, 32), 'Weights': (32, 32), 'Input': (32, 32)},
                {'Output': (4, 32, 32), 'Weights': (4, 8, 32), 'Input': (4, 32, 8)},
                ...
                {'Output': (32, 37), 'Weights': (32, 37), 'Input': (32, 32)},
                {'Output': (32, 32), 'Weights': (37, 32), 'Input': (32, 37)},
                {'Output': (1, 32), 'Weights': (32, 32), 'Input': (1, 32)}]})